...
class _NotificationLikePageState extends State<NotificationLikePage>
        ...
        child: SmartRefresher(
            ...
            child: CustomScrollView(controller: _scrollController, slivers: [
              ...
              SliverList(
                ...
                String content = '';
                if (item.notification_type == 2 && item.question_info != null) {
                                        ...
                                        children: [
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                '点赞了您的${item.notification_type == 2 ? '问题' : item.notification_type == 21 ? '答复' : '评论'} $showPublishTime',
                                                style: const TextStyle(
                                                    fontSize: 13,
                                                    fontWeight:
                                                        FontWeight.normal,
