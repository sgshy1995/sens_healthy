...
class PainSearchAllPage extends StatefulWidget {
  ...
  @override
  PainSearchAllPageState createState() => PainSearchAllPageState();
}

class PainSearchAllPageState extends State<PainSearchAllPage>
  ...
  Future<String> getPainQuestions({int? page}) {
    ...
    painClientProvider
        .getPainQuestionsByCustomAction(
            keyword: widget.keyword, pageNo: page ?? _currentPageNo + 1)
        .then((value) {
