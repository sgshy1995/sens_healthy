...
class PainReplySheetPage extends StatefulWidget {
  final String questionId;
  const PainReplySheetPage({super.key, required this.questionId});

  @override
  State<PainReplySheetPage> createState() => _PainReplySheetPageState();
}
...
class _PainReplySheetPageState extends State<PainReplySheetPage> {
    ...
    if (resultGet != null) {
      ...
      Future.delayed(const Duration(milliseconds: 500), () async {
        ...
        final List<Future<DataFinalModel<String?>>> futures =
          ...
          return painClientProvider.painReplyImageDataUploadAction(
  ...
  void checkIfCanPublish() {
    ...
    //答复内容是否填写
    if (painReplyValue == null || painReplyValue!.isEmpty) {
      publishCheckGet = false;
    }
  ...
  void handlePublish() {
    ...
    painClientProvider.painReplyCreateAction(form).then((value) {
      if (value.code == 200) {
        setState(() {
          imageDataList = [];
          galleryItems = [];
