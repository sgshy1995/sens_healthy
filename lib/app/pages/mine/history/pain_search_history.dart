...
class PainSearchHistoryPage extends StatefulWidget {
  ...
  @override
  PainSearchHistoryPageState createState() => PainSearchHistoryPageState();
}

class PainSearchHistoryPageState extends State<PainSearchHistoryPage>
  ...
  Future<String> getPainQuestions({int? page}) {
    ...
    painClientProvider
        .getPainQuestionsByCustomAction(
            ...
            collectUserId: widget.collectUserId,
