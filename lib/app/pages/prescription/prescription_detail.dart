...
class _PrescriptionDetailPageState extends State<PrescriptionDetailPage>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      (_readyLoad && prescriptionDetail.id.isNotEmpty
          ? Expanded(
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                children: [
                                  Row(
                                    children: List.generate(
                                        prescriptionDetail.difficulty, (index) {
                                      return SizedBox(
                                        width: 18,
                                        height: 18,
                                        child: Center(
                                  ...
                                  Container(
                                    ...
                                    decoration: const BoxDecoration(
                                        ...
                                        borderRadius: BorderRadius.all(
                                            Radius.circular(6))),
                                    child: Text(
                                      symptomsList[prescriptionDetail.symptoms],
                                      style: const TextStyle(
                                        color: Color.fromRGBO(211, 66, 67, 1),
                                        fontSize: 14,
                                      ),
                              ...
                              Row(
                                children: [
                                  Text('预计耗时 ${prescriptionDetail.time_length}',
                                      style: const TextStyle(
                        ...
                        Expanded(
                            child: AnimatedSwitcher(
                                ...
                                child: IndexedStack(
                                  ...
                                  key: ValueKey<int>(tabIndex), // add this line
                                  index: tabIndex,
                                  children: <Widget>[
                                    Padding(
